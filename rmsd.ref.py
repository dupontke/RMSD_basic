...
# alignment for FKBP12
alignment = 'protein and name CA and (resid 20:30 or resid 70:76 or resid 97:106)'

#alignment for dengue NS3h
...
#alignment for dengue NS5 (3evg)
alignment = 'protein and name CA and (resid __:__ or resid __:__)'
...
while start <= end:
	...
	u.load_new('%sprod.%s/protein_ligand.ti_prod.%s.ncdf' %(traj_loc,start,start))

...
#sel.append(['motif_3','protein and resid 148:154 and not name H*'])
#sel.append(['motif_4','protein and resid 195:211 and not name H*'])
#sel.append(['motif_4a','protein and resid 219:232 and not name H*'])
...
#sel.append(['hel_gate','protein and (resid 196:202 or resid 434:442) and not name H*'])
#sel.append(['a2_1','protein and resid 56:69 and not name H*'])
#sel.append(['a3_1','protein and resid 95:105 and not name H*'])
#sel.append(['',''])
